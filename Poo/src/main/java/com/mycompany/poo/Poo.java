...
public class Poo extends PApplet {
    ...
    public void setup() {
        ...
        // Llamas del cohete (círculos amarillos/naranjas)
        ...
        // Estrellas en el fondo (círculos blancos/amarillos)
        ...
        // Luna (círculo gris claro)
        figuras[23] = new Circulo(650, 100, 80, 220, 220, 220);
        
        // Cráter de la luna (círculo gris oscuro)
        figuras[24] = new Circulo(660, 90, 20, 180, 180, 180);
    }

    @Override
    public void draw() {
        background(10, 10, 40); // Fondo azul oscuro (espacio)
